...
export function CreateClub(): JSX.Element {
  ...
  return (
    <div className="rounded bg-gray-100 p-8 shadow-md">
      <h2 className="mb-4 text-xl font-bold">Create a New Club</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        >
          {createClubMutation.status === "pending" ? "Creating..." : "Create Club"}
        </button>
      </form>
